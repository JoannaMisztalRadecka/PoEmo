class PoolOfIdeas(object):
    ...
    def __str__(self):
        ...
        s += "Sentences: " + str(len(self.sentences)) + \
            str(self.sentences) + "\n"
        ...
        s += "Compraisons: " + \
            str(len(self.comparisons)) + str(self.comparisons) + "\n"
        s += "Synonyms: " + str(len(self.synonyms)) + str(self.synonyms) + "\n"
        s += "Hypernyms: " + str(len(self.hypernyms)) + \
            str(self.hypernyms) + "\n"
        s += "Antonyms: " + str(len(self.antonyms)) + str(self.antonyms) + "\n"
        s += "Emotional adjectives: " + \
            str(len(self.emotional_adjectives)) + str(self.emotional_adjectives) + "\n"
        s += "Emotional nouns: " + \
            str(len(self.emotional_nouns)) + str(self.emotional_nouns) + "\n"
        s += "Emotional adverbs: " + \
            str(len(self.emotional_adverbs)) + str(self.emotional_adverbs) + "\n"
        s += "Inspiration: " + str(self.inspiration) + "\n"
        s += "Phrases: " + str(self.phrases_dict)
        return s
